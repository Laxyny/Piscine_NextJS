    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        <div className="sidebar-tools-group">
          <button type="button" className={`sidebar-tools-toggle ${toolsOpen ? 'open' : ''}`} onClick={() => setToolsOpen(!toolsOpen)}>
            ...
            <span>Outils</span>
            <svg className="sidebar-tools-chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <polyline points="6 9 12 15 18 9"></polyline>
            </svg>
          </button>
          <div className={`sidebar-tools-menu ${toolsOpen ? 'open' : ''}`}>
            <div className="sidebar-tools-inner">
              <Link href="/career" className="settings-link" onClick={() => setToolsOpen(false)}>
                ...
                <span>Assistant carriere</span>
              </Link>
              <Link href="/quiz" className="settings-link" onClick={() => setToolsOpen(false)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 11l3 3L22 4"></path>
                  <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>
                </svg>
                <span>Quiz technique</span>
              </Link>
              <Link href="/recruiter" className="settings-link" onClick={() => setToolsOpen(false)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <Link href="/postings" className="settings-link" onClick={() => setToolsOpen(false)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
